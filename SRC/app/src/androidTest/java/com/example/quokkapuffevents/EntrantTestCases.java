...
public class EntrantTestCases {
    ...
    public void TestSecondChanceAfterUserDeclines() {
        ...
        Event event = db.CreateEvent("TestDraw", mockOrg.getId(),
                "This event is used to test if a entrant is sent a notif", 1, 1, new Date(), new Date(),
                0.0, 0.0, -1);
    ...
    public void TestAcceptInviteToEvent() {
        ...
        try {
            ...
            event = db.CreateEvent("TestDraw", mockOrg.getId(), "This event is used to test if a entrant is sent a notif",
                    1, 1, new Date(), new Date(), 0.0, 0.0, -1);
    ...
    public void TestDeclineInviteToEvent() {
        ...
        try {
            ...
            event = db.CreateEvent("TestDraw", mockOrg.getId(),
                    "This event is used to test if a entrant is sent a notif", 1,
                    1, new Date(), new Date(), 0.0, 0.0, -1);
